...
import { Mail, Lock, AlertCircle, CheckCircle, User, ArrowRight, CheckCircle2, X } from 'lucide-react';
  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Join our platform to manage your KYC documents</p>
      </div>
        ...
        <div className="mb-5">
          ...
          <div className="mt-2 space-y-2">
            <div className="flex items-center">
              ...
              <span className={`text-sm ${passwordLength ? 'text-green-600' : 'text-gray-500'}`}>
            ...
            <div className="flex items-center">
              ...
              <span className={`text-sm ${passwordHasUpper ? 'text-green-600' : 'text-gray-500'}`}>
            ...
            <div className="flex items-center">
              ...
              <span className={`text-sm ${passwordHasNumber ? 'text-green-600' : 'text-gray-500'}`}>
                At least 1 number
              </span>
            </div>
          </div>
