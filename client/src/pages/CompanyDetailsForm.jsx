...
const CompanyDetailsForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    financialYearEnd: '',
    constitutionOption: '1', // Default to option 1
  });
  ...
  const fetchCompanyDetails = async () => {
    try {
      ...
      if (data) {
        // Populate form data from fetched details
        setFormData({
          intendedCompanyName: data.intendedCompanyName?.name || '',
          alternativeCompanyName1: data.alternativeCompanyName1?.name || '',
          alternativeCompanyName2: data.alternativeCompanyName2?.name || '',
          companyActivities: data.companyActivities?.description || '',
          intendedRegisteredAddress: data.intendedRegisteredAddress?.address || '',
          financialYearEnd: data.financialYearEnd?.date || '',
          constitutionOption: data.constitution?.option || '1',
        });
        
        // Set file previews
        setFilePreview({
          intendedCompanyName: data.intendedCompanyName?.fileId?.fileUrl || null,
          alternativeCompanyName1: data.alternativeCompanyName1?.fileId?.fileUrl || null,
          alternativeCompanyName2: data.alternativeCompanyName2?.fileId?.fileUrl || null,
          companyActivities: data.companyActivities?.fileId?.fileUrl || null,
          intendedRegisteredAddress: data.intendedRegisteredAddress?.fileId?.fileUrl || null,
  ...
  const FileUploadField = ({ name, label, file, preview, required = false }) => {
          ...
          <div className="flex items-center justify-between bg-white border border-gray-200 rounded-lg p-3">
            <div className="flex items-center overflow-hidden">
              ...
              <div className="ml-3 overflow-hidden">
                ...
                <p className="text-xs text-gray-500">
                  {files[name]?.size ? `${(files[name].size / 1024 / 1024).toFixed(2)} MB` : ""}
                </p>
              </div>
            </div>
  ...
  return (
    <div>
      <div className="mb-6 flex items-center">
        <Link to={id ? `/company-details/${id}` : '/'} className="text-gray-600 hover:text-gray-900 mr-4">
          <ChevronLeft size={20} />
        </Link>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 mb-6 border border-blue-100">
        <div className="flex items-start">
          ...
          <div>
            <h2 className="text-lg font-semibold text-blue-800">How This Works</h2>
            <p className="text-blue-700 mt-1">
              Our AI-powered system analyzes your uploaded documents and extracts the necessary information 
              to complete your KYC verification. For best results, please upload clear, legible documents.
              <span className="block mt-2">Fields marked with <span className="text-red-500">*</span> are required.</span>
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                  <div>
                    ...
                    <input
                      ...
                      value={formData.intendedCompanyName}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formData.alternativeCompanyName1}
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-200"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formData.alternativeCompanyName2}
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-200"
                      placeholder="Enter alternative name"
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      value={formData.intendedRegisteredAddress}
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-200"
                      rows="4"
            ...
            <div className="space-y-8 animate-fadeIn">
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                  ...
                  <div>
                    <label className="block text-gray-700 font-medium mb-2">
                      Constitution Option <span className="text-red-500">*</span>
                    </label>
                    <select
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Select the constitution option that best fits your company structure
                    </p>
                  </div>
